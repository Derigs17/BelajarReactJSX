...
const Informasi = () => {
    ...
    <>
      ...
      <Container className='mb-5'>
        ...
        <Row className="justify-content-center">
          <Col sm={4} className='isi1   d-flex flex-column align-items-center'>
  ...
  <h4 style={{
    background: '#34745C',  // Warna hijau
    display: 'inline',  // Menampilkan sebagai elemen inline
    padding: '8px 16px',  // Padding sesuai kebutuhan
    color: '#fff',  // Warna teks putih
    borderRadius: '15px',  // Sudut bulat sesuai kebutuhan
    fontWeight: 'bold'  
  }}>Tips & Trik</h4>
</Container>
