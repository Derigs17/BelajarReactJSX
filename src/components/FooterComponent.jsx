    ...
    <Card className="Footer text-center text-white">
      <Card.Body>
        ...
        <Row className="justify-content-center mt-3">
          <Col md="auto">No.telp: +62876363778</Col>
          <Col md="auto">Email: tanamhs@gmail.com</Col>
        </Row>
        <Row className='logososialmedia mt-3  justify-content-center '>
          <Col md="auto" xs="auto">
            <a className="fb text-white" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
          ...
          <Col md="auto"xs="auto">
            <a className="fb text-white" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
          ...
          <Col md="auto"xs="auto">
            <a className="fb text-white" href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
          ...
          <Col md="auto"xs="auto">
            <a className="fb text-white" href="https://youtube.com" target="_blank" rel="noopener noreferrer">
      ...
      <Card.Footer className="text-white" style={{ borderColor: 'white' }}>
